...
namespace Play.Inventory.Service.Controllers
{
    ...
    public class ItemsController: ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<InventoryItemDto>>> GetAsync(Guid UserId)
        {
            ...
            var inventoryCatalogItemIds = inventoryItemEntities.Select(item => item.CatalogItemId);
            var catalogItemEntities = await catalogItemsRepository.GetAllAsync(item => inventoryCatalogItemIds.Contains(item.Id));
